...
@AutoConfigureStubRunner(stubsMode = StubRunnerProperties.StubsMode.REMOTE, repositoryRoot = "http://nexus/repository/maven-releases/", ids = "com.salaboy.conferences:fmtok8s-c4p")
@DirtiesContext
